...
export default function ConfigurationPage() {
  ...
  const fetchConfigs = async () => {
    try {
      const response = await fetch('http://34.18.73.81/config', {credentials: 'include'});
      ...
      />
            ...
            <ConfigSection
                ...
                fields={[
                    ...
                    { key: 'CORS_ORIGINS', label: 'CORS Allowed Origins', type: 'text', placeholder: 'https://example.com, http://34.18.73.81' },
