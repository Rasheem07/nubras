...
export default function ConfigurationPage() {
  ...
  const fetchConfigs = async () => {
    try {
      const response = await fetch('http://alnubrasstudio.ddns.net:8888/config', {credentials: 'include'});
  ...
  const saveChanges = async () => {
    ...
    try {
      const promises = Object.entries(configs).map(([key, value]) => 
        fetch('http://alnubrasstudio.ddns.net:8888/config', {
          method: 'POST',
          credentials: 'include',
      ...
      />
            ...
            <ConfigSection
                ...
                fields={[
                    ...
                    { key: 'CORS_ORIGINS', label: 'CORS Allowed Origins', type: 'text', placeholder: 'https://example.com, http://alnubrasstudio.ddns.net:8888' },
