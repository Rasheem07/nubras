...
export default function ConfigurationPage() {
  ...
  const fetchConfigs = async () => {
    try {
      const response = await fetch('http://localhost:3000/config', {credentials: 'include'});
      ...
      />
            ...
            <ConfigSection
                ...
                fields={[
                    ...
                    { key: 'CORS_ORIGINS', label: 'CORS Allowed Origins', type: 'text', placeholder: 'https://example.com, http://localhost:3000' },
