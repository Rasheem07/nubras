...
export default function TailorLogin() {
    ...
    const sendOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://34.18.99.10${apiPrefix}/login`, {
                method: 'POST',
    ...
    const verifyOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://34.18.99.10${apiPrefix}/verify-otp`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
    ...
    const resendOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://34.18.99.10${apiPrefix}/resend-otp`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ contact }),
