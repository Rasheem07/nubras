...
export default function TailorLogin() {
    ...
    const sendOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://alnubrasstudio.ddns.net:8888${apiPrefix}/login`, {
                method: 'POST',
    ...
    const verifyOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://alnubrasstudio.ddns.net:8888${apiPrefix}/verify-otp`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
    ...
    const resendOtpMutation = useMutation({
        mutationFn: async () => {
            const response = await fetch(`http://alnubrasstudio.ddns.net:8888${apiPrefix}/resend-otp`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ contact }),
