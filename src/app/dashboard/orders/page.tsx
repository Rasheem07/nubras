...
import { Loader2, Package, Truck, CheckCircle2, ClipboardCheck, PackageCheck, XCircle, Trash, ArrowLeft, Box } from 'lucide-react';
          ...
          <div ref={componentRef} className="bg-gray-800 p-8 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-gray-400">Invoice Date: {selectedOrder.date ? new Date(selectedOrder.date).toLocaleDateString() : 'N/A'}</p>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                <div className="bg-red-600/10 text-red-600 px-4 py-2.5 rounded-lg text-sm flex items-center gap-2">
              ...
              <table className="w-full text-gray-300">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="py-4 px-4 text-right">AED {selectedOrder.productPrice.toFixed(2)}</td>
                    <td className="py-4 px-4 text-right">AED {selectedOrder.totalAmount.toFixed(2)}</td>
                  </tr>
                </tbody>
                ...
                <tfoot className="border-t border-gray-600">
                  <tr>
                    ...
                    <td className="py-4 px-4 text-right font-bold text-white">AED {selectedOrder.totalAmount.toFixed(2)}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
