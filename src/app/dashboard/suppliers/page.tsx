...
export default function SupplierPage() {
    ...
    const { data: suppliers, isLoading } = useQuery({
        queryKey: ['suppliers'],
        queryFn: async () => {
            const response = await fetch('https://api.alnubrasstudio.com/inventory/suppliers', {
                credentials: 'include'
            })
    ...
    const createSupplier = async (data: any) => {
        const response = await fetch("https://api.alnubrasstudio.com/inventory/suppliers/add", {
            method: "POST",
            headers: {
